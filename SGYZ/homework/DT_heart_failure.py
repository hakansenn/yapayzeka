...
def varyansaGoreEle():
    selector = VarianceThreshold(threshold=0.0145)    #0.0105
...
df.columns=["Column"+str(i) for i in range(1, 14)]
compare = pd.crosstab(df['Column13'],df['Column6'])
print(compare)
